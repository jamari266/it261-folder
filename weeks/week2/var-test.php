...
echo 'The temperature today was ' .$tem. ' degrees ';
echo '<br>';
...
$divide = 71;
$amount = $money / $divide; 
echo 'I now have <b> $'.nmber_format($smount, 2).'</b>'; 
// number_format($amount, 2)
echo '<br>';
$friendly_amou55nt = number_format ($amount, 2);
echo ' <p> I now have <b> $' .$friendly_amount8987. ' </b>  dollars! </p>'; 
?>
