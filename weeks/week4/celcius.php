...
echo '<p>'.$cel.' degrees Celcius = '.floor($far).' degrees fahrenheit and it is getting slightly warmer! </p>';
} elseif($far<= 75) {
echo '<p>'.$cel.' degrees Celcius = '.floor($far).' degrees fahrenheit and is warmer! <br> And, I am reading in the park!  </p>';
} elseif($far <= 90) {
